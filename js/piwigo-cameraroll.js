angular.element(document).ready(function() {
    ...
    piwigoApp.controller('piwigo-ctrl', ['$scope', '$http', function($scope, $http) {
        ...
        var urlMatch = url.match(/[.]com[/]photography[/]cameraroll[/]image[/](\d+)(?:[/])?/);
        ...
        document.addEventListener('keyup', function(event) {
            ...
            if (event.keyCode === 37 && !modKey && $scope.prevImage) {
                window.location.href = '/photography/cameraroll/image/' + $scope.prevImage;
            }
        }, false);
        ...
        document.addEventListener('keyup', function(event) {
            ...
            if (event.keyCode === 39 && !modKey && $scope.nextImage) {
                window.location.href = '/photography/cameraroll/image/' + $scope.nextImage;
            }
        }, false);
    }]);
